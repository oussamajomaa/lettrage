...
function create_element(divID, numberOption, options = [], selectID) {
    ...
    for (let i = 0; i < numberOption; i++) {
        ...
        else if (options[i]=="PVC Noir 10 mm") option.value = "10#000000"
        else if (options[i]=="PVC Noir 19 mm") option.value = "19#000000"
        else if (options[i]=="PVC Noir 30 mm") option.value = "30#000000"
